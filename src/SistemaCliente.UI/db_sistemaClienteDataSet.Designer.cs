    ...
    public partial class db_sistemaClienteDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.relationFK_Cliente_Endereco = new global::System.Data.DataRelation("FK_Cliente_Endereco", new global::System.Data.DataColumn[] {
                        ...
                        this.tableEndereco.ClienteIdColumn}, false);
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClienteRow AddClienteRow(int Id, string Nome, System.DateTime DataCadastro) {
        ...
        public partial class EnderecoDataTable : global::System.Data.TypedTableBase<EnderecoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EnderecoRow AddEnderecoRow(int Id, string Tipo, string Nome, string Bairro, string Cidade) {
        ...
        public partial class EnderecoRow : global::System.Data.DataRow {
            ...
            public int ClienteId {
                get {
                    return ((int)(this[this.tableEndereco.ClienteIdColumn]));
                }
                set {
                    this[this.tableEndereco.ClienteIdColumn] = value;
                }
            }
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cliente] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1 A" +
                "ND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_DataCadastro = 1 " +
                "AND [DataCadastro] IS NULL) OR ([DataCadastro] = @Original_DataCadastro)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cliente] ([Id], [Nome], [DataCadastro]) VALUES (@Id, @Nome, @D" +
                "ataCadastro);\r\nSELECT Id, Nome, DataCadastro FROM Cliente WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cliente] SET [Id] = @Id, [Nome] = @Nome, [DataCadastro] = @DataCadastro WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_DataCadastro = 1 AND [DataCadastro] IS NULL) OR ([DataCadastro] = @Original_DataCadastro)));
SELECT Id, Nome, DataCadastro FROM Cliente WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nome, DataCadastro FROM dbo.Cliente";
        ...
        public virtual int Delete(int Original_Id, string Original_Nome, global::System.Nullable<global::System.DateTime> Original_DataCadastro) {
        ...
        public virtual int Insert(int Id, string Nome, global::System.Nullable<global::System.DateTime> DataCadastro) {
        ...
        public virtual int Update(int Id, string Nome, global::System.Nullable<global::System.DateTime> DataCadastro, int Original_Id, string Original_Nome, global::System.Nullable<global::System.DateTime> Original_DataCadastro) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, global::System.Nullable<global::System.DateTime> DataCadastro, int Original_Id, string Original_Nome, global::System.Nullable<global::System.DateTime> Original_DataCadastro) {
            return this.Update(Original_Id, Nome, DataCadastro, Original_Id, Original_Nome, Original_DataCadastro);
        }
    }
    ...
    public partial class EnderecoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Endereco] WHERE (([Id] = @Original_Id) AND ([ClienteId] = @Original_ClienteId) AND ((@IsNull_Tipo = 1 AND [Tipo] IS NULL) OR ([Tipo] = @Original_Tipo)) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Bairro = 1 AND [Bairro] IS NULL) OR ([Bairro] = @Original_Bairro)) AND ((@IsNull_Cidade = 1 AND [Cidade] IS NULL) OR ([Cidade] = @Original_Cidade)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Endereco] ([Id], [Tipo], [Nome], [Bairro], [Cidade]) VALUES (@" +
                "Id, @Tipo, @Nome, @Bairro, @Cidade);\r\nSELECT Id, ClienteId, Tipo, Nome, Bairro, " +
                "Cidade FROM Endereco WHERE (Id = @Id)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Endereco] SET [Id] = @Id, [Tipo] = @Tipo, [Nome] = @Nome, [Bairro] = @Bairro, [Cidade] = @Cidade WHERE (([Id] = @Original_Id) AND ([ClienteId] = @Original_ClienteId) AND ((@IsNull_Tipo = 1 AND [Tipo] IS NULL) OR ([Tipo] = @Original_Tipo)) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Bairro = 1 AND [Bairro] IS NULL) OR ([Bairro] = @Original_Bairro)) AND ((@IsNull_Cidade = 1 AND [Cidade] IS NULL) OR ([Cidade] = @Original_Cidade)));
SELECT Id, ClienteId, Tipo, Nome, Bairro, Cidade FROM Endereco WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, ClienteId, Tipo, Nome, Bairro, Cidade FROM dbo.Endereco";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, int Original_ClienteId, string Original_Tipo, string Original_Nome, string Original_Bairro, string Original_Cidade) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int Id, string Tipo, string Nome, string Bairro, string Cidade) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Id));
            if ((Tipo == null)) {
                this.Adapter.InsertCommand.Parameters[1].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Id, string Tipo, string Nome, string Bairro, string Cidade, int Original_Id, int Original_ClienteId, string Original_Tipo, string Original_Nome, string Original_Bairro, string Original_Cidade) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Id));
            if ((Tipo == null)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Tipo, string Nome, string Bairro, string Cidade, int Original_Id, int Original_ClienteId, string Original_Tipo, string Original_Nome, string Original_Bairro, string Original_Cidade) {
            return this.Update(Original_Id, Tipo, Nome, Bairro, Cidade, Original_Id, Original_ClienteId, Original_Tipo, Original_Nome, Original_Bairro, Original_Cidade);
        }
    }
